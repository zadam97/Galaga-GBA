...
/* Mode 3 */
extern unsigned short *videoBuffer;               // 0x6000000 //Got rid of volitile
// Need in one of your .c files:
//     volatile unsigned short *videoBuffer = (volatile unsigned short *)0x6000000;
#define REG_DISPCNT  *(volatile unsigned short *) 0x4000000
#define SCANLINECOUNTER *(volatile unsigned short *)0x4000006   //added first *
...
void drawImage3(int row, int col, int width, int height, const u16 *img);
void waitForVblank();
void delay(int n);
